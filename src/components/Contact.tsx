...
const Contact = () => {
  const badges = [
    ...
    { name: "NAR", image: "/src/assets/Logo4.png" }
  ];
          ...
          >
            <div className="flex items-center justify-center">
              <Button 
                variant="default" 
                size="lg"
                className="bg-[#25D366] hover:bg-[#20BA5A] text-white flex items-center gap-3"
                asChild
              >
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {badges.map((badge, index) => (
              <motion.div
                ...
                className="w-24 h-24 bg-white rounded-lg flex items-center justify-center p-2 shadow-md"
              >
                <img 
                  src={badge.image} 
                  alt={badge.name}
